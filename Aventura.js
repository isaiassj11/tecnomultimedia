class Aventura {
  ...
  cargarImagenes() {
    this.imagenes = [];
    for (let i = 0; i < 17; i++) { // Cambié de 14 a 16 para incluir las imágenes adicionales
...
let pantallaPerdiste = new Pantalla(this.imagenes[15]);
    ...
    // Pantalla 16 (ganaste)
    let pantallaGanaste = new Pantalla(this.imagenes[16], "Has ganado, felicitaciones");
    pantallaGanaste.agregarBoton(new Boton(400, 500, 150, 30, "Volver", 0));
